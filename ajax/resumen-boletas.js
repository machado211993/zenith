$(document).ready(function () {
  ...
  $(document).prop("title", "Resumen de Boletas - Zenith Group");
});
    ...
    if (tbl_data.length > 0) {
      ...
      switch (action) {
        ...
        case "vigente":
          Swal.fire({
            title:
              "¿Está seguro de marcar como VIGENTE la boleta " +
              data_row[1] +
              "?",
        ...
        case "pendiente":
          Swal.fire({
            title:
              "¿Está seguro de marcar como PENDIENTE DE PAGO la boleta " +
              data_row[1] +
              "?",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
        ...
        case "cancelado":
          Swal.fire({
            title:
              "¿Está seguro de marcar como CANCELADA la boleta " +
              data_row[1] +
              "?",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
