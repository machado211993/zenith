...
$(document).ready(function () {
  ...
  $(document).prop("title", "Empleados - Zenith Group");
});
    ...
    success: function (data) {
      if (data == "ERROR") {
        $.Notification.notify(
          ...
          "bottom-right",
          "Error de guardado",
          "No se pudo guardar datos del empleado"
        );
        Swal.close();
      } else if (data == "EXISTE") {
        $.Notification.notify(
          ...
          "bottom-right",
          "Error de guardado",
          "Empleado ya existe en la base de datos"
        );
        Swal.close();
...
$("#btn-delete-employee").click(function () {
  ...
  if (id_val != "" && id_val != null) {
    Swal.fire({
      ...
      if (result.value) {
        $.post(
          "../../modules/empleados/eliminar-empleado.php",
          { empleado_id: id_val },
          function (data) {
            if (data == true) {
