$(document).ready(function () {
  ...
  $(document).prop("title", "Resumen de Facturas - Zenith Group");
});
    ...
    if (tbl_data.length > 0) {
      ...
      switch (action) {
        ...
        case "vigente":
          Swal.fire({
            title:
              "¿Está seguro de marcar como VIGENTE la factura " +
              data_row[1] +
              "?",
        ...
        case "pendiente":
          Swal.fire({
            title:
              "¿Está seguro de marcar como PENDIENTE DE PAGO la factura " +
              data_row[1] +
              "?",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
        ...
        case "cancelado":
          Swal.fire({
            title:
              "¿Está seguro de marcar como CANCELADA la factura " +
              data_row[1] +
              "?",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
