...
$(document).ready(function () {
  ...
  $(document).prop("title", "Resumen de Cotizaciones - Zenith Group");
});
...
$('input[name="cotizacion_numero"]').autocomplete({
  source: function (request, response) {
    $.getJSON(
      "../../modules/cotizaciones/obtener-cotizaciones.php",
      { orden_cotizacion: $('input[name="cotizacion_numero"]').val() },
      response
    );
  },
...
$('input[name="cotizacion_numero"], input[name="cotizacion_cliente"]').on(
  "keyup",
  function () {
...
$(
  'input[name="cotizacion_numero"], input[name="cotizacion_cliente"], input[name="cotizacion_fecinic"], input[name="cotizacion_fecfin"]'
).on("change", function () {
  cotiz_nroo = $('input[name="cotizacion_numero"]').val();
  cotiz_client = $('input[name="cotizacion_cliente"]').val();
...
$("#btn-buscar").click(function () {
  ...
  if (
    ...
    $.post(
      ...
      {
        cotiz_nroo: cotiz_nroo,
        cotiz_client: cotiz_client,
        cotiz_fini: cotiz_fini,
        cotiz_ffin: cotiz_ffin,
      },
      function (data) {
        tbl_cotizaciones.clear().draw();
        data_cotiz = JSON.parse(data);
