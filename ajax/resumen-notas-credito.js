$(document).ready(function () {
  ...
  $(document).prop("title", "Resumen de Notas de Crédito - Zenith Group");
});
...
$('input[name="factura_fecini"], input[name="factura_fecfin"]').on(
  "change",
  function () {
    ...
    if (tbl_data.length > 0) {
      ...
      switch (action) {
        ...
        case "vigente":
          Swal.fire({
            title:
              "¿Está seguro de marcar como VIGENTE la nota de crédito " +
              data_row[1] +
              "?",
        ...
        case "anulado":
          Swal.fire({
            title:
              "¿Está seguro de ANULAR la nota de crédito " + data_row[1] + "?",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
        ...
        case "pendiente":
          Swal.fire({
            title:
              "¿Está seguro de marcar como PENDIENTE DE PAGO la nota de crédito " +
              data_row[1] +
              "?",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
        ...
        case "cancelado":
          Swal.fire({
            title:
              "¿Está seguro de marcar como CANCELADA la nota de crédito " +
              data_row[1] +
              "?",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
