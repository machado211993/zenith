...
$(document).ready(function () {
  ...
  $(document).prop("title", "Registro de Cotización - Zenith Group");
});
...
$('input[name="cotizacion_valcliente"]').autocomplete({
  source: function (request, response) {
    $.getJSON(
      ...
      { cotiz_nomcliente: $('input[name="cotizacion_valcliente"]').val() },
      response
    );
  },
...
$("#btn-add-prodtocotiz").click(function () {
  ...
  if (idprod != "" && cantidad != "" && cantidad > 0) {
    ...
    $('input[name="cotizacion_prodcant"]').val(0);
    $('input[name="cotizacion_prodprecio"]').val(0.0);
  ...
  if (DATA_ID != "" && DATA_ID != null) {
    ...
    $.post(
      ...
      function (data) {
        ...
        $('select[name="cotizacion_formpagotext"]').val(
        ...
        $('input[name="cotizacion_fecentrega"]').val(
        ...
        $('input[name="cotizacion_igv"]').val(
          parseFloat(data_json[0]["TOTAL_TAX"]).toFixed(2)
        );
        $('input[name="cotizacion_total"]').val(
...
$("#table-productscotiz").on("dblclick", "tr", function () {
  ...
  tbl_prodcotiz.rows(tbl_prodcotiz.row(this)).remove().draw();
        ...
        $.post(
          ...
          function (data) {
            if (data == true) {
              ...
              $('select[name="cotizacion_formpagotext"]').prop(
                "disabled",
                false
              );
              $("#div_diaspago").hide();
