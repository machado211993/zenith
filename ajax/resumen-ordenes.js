...
$(document).ready(function () {
  ...
  $(document).prop("title", "Resumen de Órdenes - Zenith Group");
});
...
$('input[name="orden_numero"]').autocomplete({
  source: function (request, response) {
    $.getJSON(
      "../../modules/ordenes/obtener-ordenes.php",
      { ORDEN_NRO: $('input[name="orden_numero"]').val() },
      response
    );
  },
...
$('input[name="orden_proveedor"]').autocomplete({
  source: function (request, response) {
    $.getJSON(
      "../../modules/proveedores/obtener-proveedores.php",
      {
...
$('input[name="orden_numero"], input[name="orden_proveedor"]').on(
  "keyup",
  function () {
...
$(
  'input[name="orden_numero"], input[name="orden_proveedor"], input[name="orden_fecinic"], input[name="orden_fecfin"]'
).on("change", function () {
  orden_nroo = $('input[name="orden_numero"]').val();
  orden_prov = $('input[name="orden_proveedor"]').val();
...
$("#btn-buscar").click(function () {
  ...
  if (
    ...
    $.post(
      ...
      {
        orden_nroo: orden_nroo,
        orden_prov: orden_prov,
        orden_fini: orden_fini,
        orden_ffin: orden_ffin,
      },
      function (data) {
        tbl_ordenes.clear().draw();
        data_orden = JSON.parse(data);
