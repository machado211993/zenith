<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $functions->direct_paginas()."home" ?>" class="brand-link">
        <img src="<?php echo $functions->direct_sistema(); ?>/img/zenith_icon.png" alt="Zenith Group Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
        <span class="brand-text font-weight-dark text-cyan"><strong>ZENITH</strong> GROUP</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview menu-close">
                    <a id="m_caja" href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a id="m_caja_chica" href="<?php echo $functions->direct_paginas()."caja/caja-chica" ?>" class="nav-link">
                                <i class="nav-icon far fa-circle text-success"></i>
                                <p>Caja Chica (Ingreso/Egreso)</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a id="m_caja_consulta" href="<?php echo $functions->direct_paginas()."caja/caja-consulta" ?>" class="nav-link">
                                <i class="nav-icon far fa-circle text-warning"></i>
                                <p>Caja Consulta (Resumen)</p>
                            </a>
                        </li>
                    </ul>
                </li>
