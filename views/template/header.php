...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $functions->direct_sistema(); ?>/css/style-zenith.css">
  ...
  <!-- Favicons -->
  <link rel="icon" href="<?php echo $functions->direct_sistema(); ?>/img/favicons/zenith_icon.ico" sizes="32x32" type="image/png">
  <link rel="icon" href="<?php echo $functions->direct_sistema(); ?>/img/favicons/zenith_icon.ico" sizes="16x16" type="image/png">
