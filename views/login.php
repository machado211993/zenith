...
<head>
  ...
  <meta property="og:site" content="Zenith">
  <meta property="og:url" content="http://localhost/zenith">
  <meta property="og:description" content="Bienvenido a Zenith. Inicie sesión para continuar.">
  <meta property="og:image" content="../img/zenith.png">

  <meta property="twitter:title" content="Zenith">
  <meta property="twitter:description" content="Bienvenido a Zenith. Inicie sesión para continuar.">
  <meta name="twitter:image" content="./img/zenith.png">
  <meta name="twitter:card" content="summary_large_image">
  <!--<meta name="twitter:site" content="@zenith">-->

  <link rel="icon" href="./img/favicons/zenith_icon.ico" sizes="32x32" type="image/png">
  <link rel="icon" href="./img/favicons/zenith_icon.ico" sizes="16x16" type="image/png">
  ...
  <main class="form-signin w-100 m-auto">
    <form id="login-form">
      <div class="text-center">
        <img class="mb-4" src="./img/zenith.png" width="225" height="225">
      </div>
      ...
      <p class="mt-5 mb-3 text-body-secondary text-center">&copy; 2025 Zenith</p>
    </form>
  </main>
